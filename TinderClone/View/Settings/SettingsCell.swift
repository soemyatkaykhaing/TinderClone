...
//  TinderClone
//
//  Created by MacBook on 20/08/2020.
...
protocol SettingsCellDelegate: class {
    ...
    func settingsCell(_ cell: SettingsCell, wantsToUpdateAgeRagneWith sender: UISlider)
}
class SettingsCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        minStack.spacing = 24
        let maxStack = UIStackView(arrangedSubviews: [maxAgeLabel,minAgeSlider])
        maxStack.spacing = 24
    ...
    @objc func handleAgeRangeChanged(sender: UISlider){
        ...
        delegate?.settingsCell(self, wantsToUpdateAgeRagneWith: sender)
    }
    // MARK: - Helper
